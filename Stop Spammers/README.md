## Stop Spammers settings key

Tested version of WordPress 5.2.2, plugin version was Speed Booster Pack 2019.

This file is a key for the settings of the [Stop Spammers](https://wordpress.org/plugins/stop-spammer-registrations-plugin/). 
