## WP Search Insights settings key

Tested version of WordPress 5.3.1, plugin version was WP Search Insights 1.0.0.

This file is a key for the different settings of [WP Search Insights](https://wordpress.org/plugins/wp-search-insights/). 
