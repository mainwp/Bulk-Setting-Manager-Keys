## Yoast Duplicate Post settings keys

Tested version of WordPress 5.4.2, plugin version was Yoast Duplicate Post 3.2.5.

This file is a key for the different settings of [Yoast Duplicate Post](https://wordpress.org/plugins/duplicate-post/). 
