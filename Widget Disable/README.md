## Widget Disable settings keys

Tested version of WordPress 5.5, plugin version was Widget Disable 2.0.0.

This file is a key for the different settings of [Widget Disable](https://wordpress.org/plugins/wp-widget-disable/). 
