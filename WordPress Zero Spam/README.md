## WordPress Zero Spam settings keys

Tested version of WordPress 5.4.2, plugin version was WordPress Zero Spam 4.9.10.

This file is a key for the different settings of [WordPress Zero Spam](https://wordpress.org/plugins/zero-spam/). 
