## WP Compress default settings keys

Tested version of WordPress 4.9.8, plugin version was WP Compress 2.8.1

This file is a key for the different settings of [WP Compress](https://wordpress.org/plugins/wp-compress-image-optimizer/). 
