## NitroPack settings key

Tested version of WordPress 5.7.1, plugin version was NitroPack 1.5.4.

This file is a key for the settings of the [NitroPack](https://wordpress.org/plugins/nitropack/). 
